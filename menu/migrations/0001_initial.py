    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=menu.utils.dish_image_path, verbose_name='Зображення страви')),
                ...
                ('menus', models.ManyToManyField(related_name='dishes', to='menu.dishmenu', verbose_name='Меню страви')),
            ],
        ),
    ]
